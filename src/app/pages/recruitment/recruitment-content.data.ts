...
const VI: RecruitmentContent = {
  ...
  companyLine: 'Tại Công ty TNHH Thanh Hoà',
  tagline: 'Tham gia Thanh Hoà – Cùng chúng tôi phát triển vì một tương lai bền vững',
  intro:
    'Công ty TNHH Thanh Hoà là nhà sản xuất và xuất khẩu dăm gỗ, viên gỗ sinh khối và các sản phẩm gỗ. Với môi trường làm việc chuyên nghiệp, ổn định và cơ hội phát triển nghề nghiệp tuyệt vời, chúng tôi chào đón những cá nhân năng động, có trách nhiệm và tận tâm đang tìm kiếm cơ hội xây dựng sự nghiệp lâu dài cùng công ty.',
