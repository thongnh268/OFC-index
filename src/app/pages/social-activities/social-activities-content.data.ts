  ...
  blocks: [
    {
      ...
      paragraphs: [
        'At Thanh Hoa Limited Company, we believe that sustainable development is measured not only by business and production efficiency but also by the positive values brought to the community and society.',
        'Throughout our operations, Thanh Hoa has always highly regarded social responsibility, considering it an inseparable part of our corporate development strategy. Besides creating stable jobs for workers, we continuously implement community-oriented programs, contributing to improving the quality of life and promoting sustainable development locally.',
      ],
    },
    {
      heading: 'Standing with Employees',
      paragraphs: [
        'People are the foundation of all success. Thanh Hoa always focuses on building a safe, professional, and humane working environment, ensuring full welfare benefits, insurance, and working conditions for employees.',
    ...
    },
    {
      ...
      paragraphs: [
        'With the desire to share and spread love, Thanh Hoa actively participates in local social welfare programs such as:',
      ],
      list: [
    ...
    },
    {
      ...
      paragraphs: [
        'As an enterprise operating in the forestry sector, Thanh Hoa is deeply aware of its responsibility in protecting forest resources and the environment.',
    ...
    },
    {
      ...
      paragraphs: [
        'Thanh Hoa understands that business success is always linked to the development of the community and the environment. Therefore, we are committed to continuing to implement practical social responsibility programs, creating positive values ​​for our employees, customers, partners, and society.',
      ],
    },
    {
      paragraphs: [
        '<accent>Every product created brings not only economic value but is also a commitment from Thanh Hoa to people, the community, and a green future for generations to come</accent>',
      ],
    },
  ],
};
  ...
  blocks: [
    {
      ...
      paragraphs: [
        'Tại Công ty TNHH Thanh Hoà, chúng tôi tin rằng sự phát triển bền vững không chỉ được đo bằng hiệu quả kinh doanh và sản xuất, mà còn bằng những giá trị tích cực mang lại cho cộng đồng và xã hội.',
        'Trong suốt quá trình hoạt động, Thanh Hoà luôn đề cao trách nhiệm xã hội, xem đây là một phần không thể tách rời trong chiến lược phát triển của doanh nghiệp. Bên cạnh việc tạo công ăn việc làm ổn định cho người lao động, chúng tôi liên tục triển khai các chương trình hướng đến cộng đồng, góp phần nâng cao chất lượng cuộc sống và thúc đẩy phát triển bền vững tại địa phương.',
      ],
    },
    {
      heading: 'Đồng hành cùng người lao động',
      paragraphs: [
        'Con người là nền tảng của mọi thành công. Thanh Hoà luôn chú trọng xây dựng môi trường làm việc an toàn, chuyên nghiệp và nhân văn, đảm bảo đầy đủ phúc lợi, bảo hiểm và điều kiện làm việc cho người lao động.',
    ...
    },
    {
      ...
      paragraphs: [
        'Với mong muốn sẻ chia và lan tỏa yêu thương, Thanh Hoà tích cực tham gia các chương trình an sinh xã hội tại địa phương như:',
      ],
      list: [
    ...
    },
    {
      ...
      paragraphs: [
        'Là doanh nghiệp hoạt động trong lĩnh vực lâm nghiệp, Thanh Hoà nhận thức sâu sắc trách nhiệm của mình trong việc bảo vệ tài nguyên rừng và môi trường.',
    ...
    },
    {
      ...
      paragraphs: [
        'Thanh Hoà hiểu rằng sự thành công của doanh nghiệp luôn gắn liền với sự phát triển của cộng đồng và môi trường. Vì vậy, chúng tôi cam kết tiếp tục triển khai các chương trình trách nhiệm xã hội thiết thực, tạo ra những giá trị tích cực cho nhân viên, khách hàng, đối tác và xã hội.',
      ],
    },
    {
      paragraphs: [
        '<accent>Mỗi sản phẩm được tạo ra không chỉ mang lại giá trị kinh tế mà còn là cam kết của Thanh Hoà với con người, cộng đồng và một tương lai xanh cho các thế hệ mai sau</accent>',
      ],
    },
  ],
};
