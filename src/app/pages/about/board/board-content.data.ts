...
const LETTER_EN: readonly string[] = [
  ...
  'On behalf of the Board of Management and all employees of Thanh Hoa Limited Company, I would like to extend our respectful greetings, sincere thanks, and deepest gratitude for your trust, companionship, and valuable cooperation over the years.',
  'Throughout our journey of building and developing, Thanh Hoa has always kept in mind that our success is measured not only by production scale or export volume, but also by the trust of our customers, the strong bonds with our partners, and the sustainable values we bring to the community and society.',
  'As a company operating in the processing and exporting of wood chips, biomass wood pellets, and other wood products, we continuously invest in technology, perfect our quality management systems, and develop legal, sustainable raw material sources to meet the increasingly rigorous standards of the international market. Every product bearing the Thanh Hoa brand is not merely the outcome of a strict production process, but also a testament to our commitment to quality, credibility, and environmental responsibility.',
  'We understand that our achievements today bear the significant hallmark of your companionship. Your trust and enduring cooperation have become the driving force for Thanh Hoa to continuously innovate, enhance our competitive capacity, and steadily affirm our position in both domestic and international markets.',
  'With a long-term strategic vision, Thanh Hoa continues to pursue the goal of building a sustainable forestry value chain, developing stable raw material zones, improving service quality, and creating environmentally friendly products. We aim to contribute to the growth of a green economy and the reduction of global carbon emissions.',
  'We commit to maintaining a spirit of sincere, transparent, and responsible cooperation. We will continuously improve to provide you with the best products and services, truly worthy of the trust you have placed in Thanh Hoa.',
...
const LETTER_VI: readonly string[] = [
  ...
  'Thay mặt Ban Lãnh đạo cùng toàn thể cán bộ, công nhân viên Công ty TNHH Thanh Hoà, tôi xin gửi tới Quý vị lời chào trân trọng, lời cảm ơn chân thành và sự tri ân sâu sắc nhất vì sự tin tưởng, đồng hành và hợp tác quý báu trong suốt thời gian qua.',
  'Trên hành trình xây dựng và phát triển, Thanh Hoà luôn tâm niệm rằng thành công của doanh nghiệp không chỉ được đo bằng quy mô sản xuất hay sản lượng xuất khẩu, mà còn được tạo nên từ niềm tin của khách hàng, sự gắn kết của đối tác và những giá trị bền vững mà chúng tôi mang lại cho cộng đồng và xã hội.',
  'Là doanh nghiệp hoạt động trong lĩnh vực chế biến và xuất khẩu dăm gỗ, viên nén gỗ sinh khối và các sản phẩm từ gỗ, chúng tôi không ngừng đầu tư công nghệ, hoàn thiện hệ thống quản lý chất lượng, phát triển nguồn nguyên liệu hợp pháp và bền vững nhằm đáp ứng những tiêu chuẩn ngày càng cao của thị trường quốc tế. Mỗi sản phẩm mang thương hiệu Thanh Hoà không chỉ là kết quả của quá trình sản xuất nghiêm ngặt mà còn là cam kết về chất lượng, uy tín và trách nhiệm đối với môi trường.',
  'Chúng tôi hiểu rằng, những thành tựu đạt được hôm nay đều có dấu ấn quan trọng từ sự đồng hành của Quý Khách hàng và Quý Đối tác. Chính sự tin tưởng và hợp tác bền chặt của Quý vị đã trở thành động lực để Thanh Hoà không ngừng đổi mới, nâng cao năng lực cạnh tranh và từng bước khẳng định vị thế của mình trên thị trường trong nước cũng như quốc tế.',
  'Với định hướng phát triển lâu dài, Thanh Hoà tiếp tục theo đuổi mục tiêu xây dựng chuỗi giá trị lâm sản bền vững, phát triển vùng nguyên liệu ổn định, nâng cao chất lượng dịch vụ và tạo ra những sản phẩm thân thiện với môi trường, góp phần vào sự phát triển của nền kinh tế xanh và giảm phát thải carbon toàn cầu.',
  'Chúng tôi cam kết sẽ luôn giữ vững tinh thần hợp tác chân thành, minh bạch và trách nhiệm; không ngừng cải tiến để mang đến cho Quý Khách hàng những sản phẩm và dịch vụ tốt nhất, xứng đáng với niềm tin mà Quý vị đã dành cho Thanh Hoà.',
...
const EN: BoardContent = {
  ...
  managers: [
    { icon: 'factory', label: 'Manager of Thanh Hoa Wood Chip Factory' },
    { icon: 'factory', label: 'Manager of PTSC Wood Chip Factory' },
    { icon: 'factory', label: 'Manager of Thanh Hoa Laminated Timber Factory' },
  ...
  signature: { role: 'Board of Management\nThanh Hoa Limited Company', signed: '(Signed)' },
};
...
const VI: BoardContent = {
  ...
  managers: [
    { icon: 'factory', label: 'Quản lý Nhà máy Dăm gỗ Thanh Hoà' },
    { icon: 'factory', label: 'Quản lý Nhà máy Dăm gỗ PTSC' },
    { icon: 'factory', label: 'Quản lý Nhà máy Gỗ ghép Thanh Hoà' },
  ...
  signature: { role: 'Ban Điều hành \nCông ty TNHH Thanh Hoà', signed: '(Đã ký)' },
};
